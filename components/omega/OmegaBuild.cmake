...
macro(common)
  ...
  option(OMEGA_GEOM_SINGLE_PRECISION "Use single precision real type for geometry." OFF)
...
macro(init_standalone_build)
  ...
  if (${OMEGA_GEOM_SINGLE_PRECISION} STREQUAL "ON")
    message(STATUS "OMEGA_GEOM_PRECISION = SINGLE")
  else()
    message(STATUS "OMEGA_GEOM_PRECISION = DOUBLE")
  endif()
