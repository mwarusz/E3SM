...
macro(print_config_summary)
  message(STATUS "")
  message(STATUS "Omega build configuration:")
  message(STATUS "  OMEGA_DEBUG            = ${OMEGA_DEBUG}")
  message(STATUS "  OMEGA_BUILD_TEST       = ${OMEGA_BUILD_TEST}")
  message(STATUS "  OMEGA_C_COMPILER       = ${OMEGA_C_COMPILER}")
  message(STATUS "  OMEGA_CXX_COMPILER     = ${OMEGA_CXX_COMPILER}")
  message(STATUS "  OMEGA_Fortran_COMPILER = ${OMEGA_Fortran_COMPILER}")
  message(STATUS "  OMEGA_ARCH             = ${OMEGA_ARCH}")
  ...
  if (OMEGA_VECTOR_LENGTH)
    message(STATUS "  OMEGA_VECTOR_LENGTH    = ${OMEGA_VECTOR_LENGTH}")
  else()
    message(STATUS "  OMEGA_VECTOR_LENGTH    = AUTO")
  endif()
endmacro()
