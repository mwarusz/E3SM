...
int setScalar(const Functor &Fun, const Array2DReal &ScalarElement,
   ...
   int NElementsOwned;
   Array1DGeomReal XElement, YElement;
   Array1DGeomReal LonElement, LatElement;
...
inline int computeErrors(ErrorMeasures &ErrorMeasures,
   ...
   case OnEdge:
      ...
      // in the mesh class
      {
         ...
         AreaElement  = Array1DGeomReal("AreaEdge", Mesh->NEdgesOwned);
         parallelFor(
