...
int main(int argc, char *argv[]) {
   ...
   // Tests that the correct vertex counts have been retrieved from the Decomp
   // object
   ...
   // Test dcEdge
   // Compute spherical distance between cell centers and compare to value that
   // was read in
   ...
   // Test dvEdge
   // Compute spherical distance between vertices on edges and compare to value
   // that was read in
   ...
   // Test fVertex
   // Compute the Coriolis parameter for vertices and compare with values that
   // were read in
