...
int initState() {
   ...
   Tracers::getAll(TracerArray, 0);
   deepCopy(TracerArray, 1000);
...
ErrorMeasures computeErrors() {
   ...
   computeErrors(VelErrors, NormalVelEdge, ExactNormalVelEdge, TestMesh,
                 OnEdge);
