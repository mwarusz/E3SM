...
void WindForcingAuxVars::registerFields(
   ...
   //     "kinetic energy of horizontal velocity on cells", // long
   //     name/describe "m^2 s^-2",                                       //
   //     units "specific_kinetic_energy_of_sea_water",           // CF standard
   //     Name 0,                                                // min valid
   //     value std::numeric_limits<Real>::max(),                 // max valid
   //     value FillValue, // scalar for undefined entries 2,         // number
   //     of dimensions DimNames   // dim names
   //);
   ...
   //     FillValue,                           // scalar used for undefined
   //     entries NDims,                               // number of dimensions
   //     DimNames                             // dimension names
   //);

   //// Add fields to FieldGroup
   // Err = FieldGroup::addFieldToGroup(KineticEnergyCell.label(),
   // AuxGroupName); if (Err != 0)
