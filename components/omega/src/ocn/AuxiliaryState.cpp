...
AuxiliaryState *AuxiliaryState::create(const std::string &Name,
   ...
   OMEGA_REQUIRE(
       MeshHalo,
       "Null Halo pointer in AuxiliaryState::create with Name = {}", Name);
   OMEGA_REQUIRE(
       VCoord,
...
void AuxiliaryState::init() {
   ...
   OMEGA_REQUIRE(DefVAdv, "Null default VertAdv pointer in AuxiliaryState::init");
   ...
   OMEGA_REQUIRE(OmegaConfig, "Null OmegaConfig pointer in AuxiliaryState::init");
