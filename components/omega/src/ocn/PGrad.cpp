...
void PressureGrad::init() {
   ...
   OMEGA_REQUIRE(DefMesh, "Null default HorzMesh pointer in PressureGrad::init");
...
PressureGrad::create(const std::string &Name, /// [in] Name for PressureGrad
   ...
   OMEGA_REQUIRE(
       Mesh, "Null HorzMesh pointer in PressureGrad::create with Name = {}",
       Name);
   OMEGA_REQUIRE(
       VCoord, "Null VertCoord pointer in PressureGrad::create with Name = {}",
       Name);
   OMEGA_REQUIRE(
       Options, "Null Config pointer in PressureGrad::create with Name = {}",
       Name);
