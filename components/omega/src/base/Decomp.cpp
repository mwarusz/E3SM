...
void Decomp::partCellsParMetisKWay(
   ...
   bool TimerFlag = Pacer::start("Metis partitioning", 3);
   ...
   TimerFlag = Pacer::stop("Metis partitioning", 3);
   if (MetisErr != METIS_OK)
      ABORT_ERROR("Decomp: Error in ParMETIS");
   ...
   TimerFlag  = Pacer::start("partCellsGatherOwned", 3);
   ...
   TimerFlag = Pacer::stop("partCellsGatherOwned", 3);
   ...
   TimerFlag      = Pacer::start("partCellsGatherHalos", 3);
   ...
   TimerFlag = Pacer::stop("partCellsGatherHalos", 3);
